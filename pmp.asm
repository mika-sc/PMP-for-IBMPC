...
read_error_mes	db	"File can not found!",13,10,"$"
...
fade_MES	DB	"Fading out.",13,10,"$"

efcstop_mes	db	"FM/SSG sound effect stopped.",13,10,"$"

notres_mes	db	"PMD is not installed!",13,10,"$"

pcm_access_mes	db	"ADPCM is accessing.",13,10,"$"

over_error_mes	db	"Insufficient song data buffer!",13,10,"$"
